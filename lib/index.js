...
var paginate = exports.paginate = function paginate(opts) {
  var createPage = opts.createPage,
      ...
      _opts$trailingSlash = opts.trailingSlash,
      trailingSlash = _opts$trailingSlash === undefined ? false : _opts$trailingSlash;
  ...
  (0, _times2.default)(function (pageNumber) {
    ...
    var path = (0, _utils.paginatedPath)(pathPrefix, pageNumber, numberOfPages, trailingSlash);

    // Calculate the path for the previous and next pages
    var previousPagePath = (0, _utils.paginatedPath)(pathPrefix, pageNumber - 1, numberOfPages, trailingSlash);
    var nextPagePath = (0, _utils.paginatedPath)(pathPrefix, pageNumber + 1, numberOfPages, trailingSlash);
